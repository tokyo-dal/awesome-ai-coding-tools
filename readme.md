...
- [Windsurf](https://windsurf.com/) – AI-powered code editor with powerful and advanced flexible coding agent beyond simple autocompletion.
...
- [Trae](https://www.trae.ai/) – Adaptive AI IDE that helps you code faster and collaborate with AI.
- [StackSpot AI](https://ai.stackspot.com/) – AI platform for enterprise-grade code generation and developer efficiency.
- [Blackbox AI](https://www.blackbox.ai/) – AI-driven coding assistant with intelligent code completions and documentation.
...
- [Supercode.sh](https://supercode.sh/) – Cursor extension upgrading AI agent with Architect Mode, voice input, and prompt enhancement.
- [SpecStory](https://specstory.com/) – Extension for summarizing context across AI chats and preserving/sharing task intents.
- [Task Master](https://github.com/eyaltoledano/claude-task-master) – Task management system for AI-driven development with Claude, designed for Cursor AI.
- [Memory Bank](https://github.com/vanzan01/cursor-memory-bank) – Token-optimized, hierarchical task management system integrating with Cursor.
- [Context7](https://context7.com/) – MCP server with up-to-date documentation for LLMs and AI code editors with token-usage management.
...
- [GitHub Copilot Chat](https://github.com/features/copilot/chat) – Conversational AI interface for GitHub Copilot enabling natural language coding discussions.
...
- [Codestral](https://mistral.ai/news/codestral) – Open-weight generative AI model explicitly designed for code generation tasks.
...
- [Codename Goose](https://github.com/block/goose) – Desktop and CLI tool that automates tasks using LLMs and extensions.
...
- [JunieAI (JetBrains)](https://www.jetbrains.com/junieai/) – AI coding agent that plans, writes, tests, and refactors code within JetBrains IDEs.
...
- [Lovable](https://lovable.dev/) – AI-powered platform that creates and deploys apps from a single browser tab.
- [Capacity](https://capacity.so/) – Agentic coding platform using Claude Code to turn ideas into full stack web apps.
- [Shakespeare](https://shakespeare.diy) – Open-source & decentralized AI tool for building web apps with natural language chat.
- [CreateLex](https://createlex.com) – AI-powered Unreal Engine plugin for generating Blueprints, C++ code, and node graphs using natural language.
...
- [Deepsite](https://huggingface.co/spaces/enzostvs/deepsite) – AI platform that helps you build stunning websites, no code required.
...
## 🛡️ AI Security Tools
- [Snyk Code AI](https://snyk.io/product/snyk-code/) – SAST tool for scanning source code vulnerabilities powered by DeepCode AI.
- [Snyk API & Web](https://snyk.io/product/api-security/) – DAST tool for discovering and testing security of running APIs and web applications using AI-driven analysis.
- [GitGuardian AI](https://www.gitguardian.com/) – AI-based tool monitoring codebases for leaked secrets, API keys, and sensitive information across repositories.
- [Bearer CLI](https://github.com/Bearer/bearer) – Open-source AI tool for static security analysis, detecting sensitive data exposure and ensuring compliance.
- [HackerOne Code](https://www.hackerone.com/product/code) – Combines AI and human expertise for code security with context-aware vulnerability detection and remediation.
- [Endor Labs AI Code Security](https://www.endorlabs.com/ai-code-security-review) – AI-driven code review platform analyzing pull requests for security risks, architectural changes, and business logic vulnerabilities.
- [Code Intelligence CI Fuzz](https://www.code-intelligence.com/) – AI-automated fuzz testing tool for C/C++ and other languages, finding and fixing critical bugs and vulnerabilities.
...
- [Awesome Content Marketing](https://github.com/marketinguys/awesome-content-marketing) – Content marketing resources and tools.
